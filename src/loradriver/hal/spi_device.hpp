...
public:
    ...
    [[nodiscard]] virtual LoRaError transfer(std::uint8_t addr, const std::uint8_t* tx,
                                             std::uint8_t* rx, std::size_t len) noexcept = 0;
    ...
    [[nodiscard]] LoRaError burst_write(std::uint8_t reg, const std::uint8_t* buf,
                                        std::size_t len) noexcept;
    [[nodiscard]] LoRaError burst_read(std::uint8_t reg, std::uint8_t* buf,
                                       std::size_t len) noexcept;
